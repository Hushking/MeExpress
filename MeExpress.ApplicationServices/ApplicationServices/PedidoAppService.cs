...
namespace MeExpress.ApplicationServices
{
    public class PedidoAppService : IPedidoAppService
    {
        ...
        public PedidoAppService(IPedidoRepository pedidoRepositoryInstance,
            IProdutoRepository produtoRepositoryInstance,
            IClienteRepository clienteRepositoryInstance
            )
        {
